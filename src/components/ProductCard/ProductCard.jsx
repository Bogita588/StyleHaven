...
export default function ProductCard({ product, onAddToCart, onAddToWishlist }) {
  return (
    <Card className="product-card" elevation={3}>
      <Link to={`/product/${product.id}`} className="product-card__link" style={{ textDecoration: 'none', color: 'inherit' }}>
        <CardMedia
          component="img"
          height="200"
      ...
      <Typography variant="h6" color="primary" className="product-card__price" sx={{ pl: 2 }}>
